...
export type GetPostListQuery = { __typename?: 'Query', getPostList: { __typename?: 'GetPostListOutput', posts?: Array<{ __typename?: 'Post', id: number, title: string, contents: string, hits: number, category: { __typename?: 'Category', id: number, categoryTitle: string }, hashtags: Array<{ __typename?: 'Hashtag', id: number, hashtag: string }> }> | null } };
