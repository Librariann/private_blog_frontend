...
interface RadioButtonsProps {
  categoryParent: (value: boolean) => void;
}

const RadioButtons = ({ categoryParent }: RadioButtonsProps) => {
  return (
    <StyledWrapper>
      <div className="fullscreen-container">
        <div className="radio-group-container">
          <label className="radio-label">
            ...
            <span className="radio-text">대분류</span>
          </label>
          <label className="radio-label">
            <input
              type="radio"
            ...
            />
            <span className="radio-custom" />
            <span className="radio-text">소분류</span>
          </label>
        </div>
      </div>
    </StyledWrapper>
