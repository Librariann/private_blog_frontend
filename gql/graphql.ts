...
export type GetPostListQuery = { __typename?: 'Query', getPostList: { __typename?: 'GetPostListOutput', posts?: Array<{ __typename?: 'Post', id: number, title: string, contents: string, excerpt?: string | null, hits: number, thumbnailUrl?: string | null, createdAt: any, category: { __typename?: 'Category', id: number, categoryTitle: string, parentCategoryTitle?: string | null }, comments: Array<{ __typename?: 'Comment', comment: string }>, hashtags: Array<{ __typename?: 'Hashtag', hashtag: string }> }> | null } };
