...
const documents = {
    ...
    "\n  query getPostListByCategoryId($categoryId: Int!, $offset: Int!, $limit: Int!) {\n    getPostListByCategoryId(categoryId: $categoryId, offset: $offset, limit: $limit) {\n      ok\n      error\n      hasMore\n      totalCount\n      totalViews\n      averageReadTime\n      posts {\n        id\n        title\n        excerpt\n        contents\n        hits\n        thumbnailUrl\n        createdAt\n        readTime\n        category {\n          id\n          categoryTitle\n          parentCategory {\n            id\n            categoryTitle\n          }\n        }\n        comments {\n          comment\n        }\n        hashtags {\n          hashtag\n        }\n      }\n    }\n  }\n": types.GetPostListByCategoryIdDocument,
    "\n  query getPostsByParentCategoryId($categoryId: Int!, $offset: Int!, $limit: Int!) {\n    getPostsByParentCategoryId(categoryId: $categoryId, offset: $offset, limit: $limit) {\n      ok\n      error\n      hasMore\n      totalCount\n      totalViews\n      averageReadTime\n      posts {\n        id\n        title\n        excerpt\n        contents\n        hits\n        thumbnailUrl\n        createdAt\n        readTime\n        category {\n          id\n          categoryTitle\n          parentCategory {\n            id\n            categoryTitle\n          }\n        }\n        comments {\n          comment\n        }\n        hashtags {\n          hashtag\n        }\n      }\n    }\n  }\n": types.GetPostsByParentCategoryIdDocument,
    "\n  query getCategories {\n    getCategories {\n      ok\n      error\n      categories {\n        id\n        categoryTitle\n        sortOrder\n        icon\n        iconColor\n        description\n        postCount\n        parentCategory {\n          id\n          categoryTitle\n        }\n        subCategories {\n          id\n          categoryTitle\n          icon\n          iconColor\n          sortOrder\n          description\n          parentCategory {\n            id\n            categoryTitle\n            sortOrder\n            icon\n            iconColor\n            description\n          }\n          postCount\n        }\n      }\n    }\n  }\n": types.GetCategoriesDocument,
    "\n  query getPostById($postId: Int!) {\n    getPostById(postId: $postId) {\n      ok\n      post {\n        id\n        title\n        contents\n        hits\n        createdAt\n        readTime\n        thumbnailUrl\n        postStatus\n        excerpt\n        user {\n          id\n        }\n        category {\n          id\n          categoryTitle\n          parentCategory {\n            categoryTitle\n          }\n        }\n        hashtags {\n          hashtag\n        }\n        comments {\n          id\n          annonymousId\n          comment\n          createdAt\n        }\n      }\n      prevPost {\n        id\n        title\n        createdAt\n        readTime\n      }\n      nextPost {\n        id\n        title\n        createdAt\n        readTime\n      }\n    }\n  }\n": types.GetPostByIdDocument,
    "\n  mutation createComment($input: CreateCommentInput!) {\n    createComment(input: $input) {\n      ok\n      error\n      message\n      commentResult {\n        id\n        annonymousId\n        comment\n        createdAt\n      }\n      commentId\n    }\n  }\n": types.CreateCommentDocument,
    "\n  \n  query getPostList {\n    getPostList {\n      posts {\n        ...PostFields\n      }\n      featuredPost {\n        id\n        title\n        excerpt\n        category {\n          id\n          categoryTitle\n          parentCategory {\n            id\n            categoryTitle\n          }\n        }\n      }\n    }\n  }\n": types.GetPostListDocument,
    "\n  \n  query getPostListWithLimit {\n    getPostListWithLimit {\n      posts {\n        ...PostFields\n      }\n      featuredPost {\n        id\n        title\n        excerpt\n        category {\n          id\n          categoryTitle\n          parentCategory {\n            id\n            categoryTitle\n          }\n        }\n      }\n    }\n  }\n": types.GetPostListWithLimitDocument,
